// M8 candidate for the exact wallet operation D = 8 * a * R.
//
...
// immediately running a 64-bit carry chain.  Keep M7 as the frozen baseline.
...
kernel void derivation_m8_radix2625_lazyadd_niels(
    device const uchar *view_scalar [[buffer(0)]],
    device const uchar *points [[buffer(1)]],
    device uchar *results [[buffer(2)]],
    device uchar *valid [[buffer(3)]],
